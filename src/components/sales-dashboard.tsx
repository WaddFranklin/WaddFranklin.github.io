...
export function SalesDashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* 2. Classes de responsividade refinadas aqui */}
      <div
        className={cn(
          'flex flex-col items-start gap-4', // Padrão mobile: coluna, alinhado à esquerda
          'sm:flex-row sm:items-center sm:justify-between', // Desktop: linha, centralizado e com espaço entre
        )}
      >
        ...
        {/* 3. Container dos botões agora ocupa toda a largura no mobile */}
